...
export default function ProductCategoryEditScreen() {
    ...
    const { id: productCategoryId } = params;
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                ...
                const { data } = await axios.get(`http://localhost:5000/api/productscategories/${productCategoryId}`);
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            await axios.put(
                `http://localhost:5000/api/productscategories/${productCategoryId}`,
    ...
    return (
        <div className="grid md:grid-cols-8 md:gap-0 mt-2">
            <Helmet>
                <title>Tec Data - Edit Product Category ${productCategoryId}</title>
            </Helmet>
            <div>
                <SideNavbar />
            </div>
                ...
                {loading ? (
                    ...
                    <div className='overflow-x-hidden'>
                        <div className="mx-auto max-w-screen-md overflow-x-hidden">
                            <h1 className='text-xl font-bold text-blue-600'>Edit Product Category {productCategoryId}</h1>
